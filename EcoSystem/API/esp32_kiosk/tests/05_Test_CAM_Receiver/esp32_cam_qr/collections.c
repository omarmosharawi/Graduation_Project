 ...
 * Copyright (c) 2013-2017 Ibrahim Abdelkader <iabdalkader@openmv.io> & Kwabena
 * W. Agyeman <kwagyeman@openmv.io> This work is licensed under the MIT license,
...
void lifo_clear(lifo_t *ptr) { ptr->len = 0; }

size_t lifo_size(lifo_t *ptr) { return ptr->len; }

bool lifo_is_not_empty(lifo_t *ptr) { return ptr->len; }

bool lifo_is_not_full(lifo_t *ptr) { return ptr->len != ptr->size; }
